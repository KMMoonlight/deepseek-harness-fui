/** Supervise the loopback FUI Host owned by the desktop application. */
...
/** Options for the real `dsh --profile fui` child. */
export interface SpawnDshFuiOptions {
...
/**
 * Spawn the production FUI Host on an OS-assigned loopback port.
 ...
 */
export function spawnDshFui(options: SpawnDshFuiOptions): HostChild {
