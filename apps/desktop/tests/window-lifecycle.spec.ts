...
describe('desktop window lifecycle', () => {
  ...
  it('coalesces explicit quit and releases Electron after Host disposal', async () => {
    const window = fakeWindow()
    ...
    expect(lifecycle.requestQuit()).toBe(first)
  ...
  it('reports disposal failure and still releases Electron quit', async () => {
