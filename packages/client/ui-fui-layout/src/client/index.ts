...
import { en, zh, type FuiLayoutKey } from './locales.ts'
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface LocaleNamespaceMap {
    /** FUI application-shell chrome. */
    'fui-layout': FuiLayoutKey
  }
}

/** Dictionary namespace owned by the FUI layout. */
const LOCALE_NAMESPACE = 'fui-layout'
 ...
 * the locale namespace, and the inject hook that hands the store's bound
...
export function apply(ctx: ClientContext): void {
  ...
  }, 'ui-fui-layout: service + root registration')
