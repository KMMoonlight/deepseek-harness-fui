...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-fui': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  'packages/client/ui-fui-surface': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  'packages/client/ui-fui-layout': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  ...
  'packages/client/ui-settings-plugin-installer': { kind: 'none', reason: 'Browser-side desktop installer form; registers nothing model-facing.' },
  ...
  'packages/client/ui-settings-runtime-updater': { kind: 'none', reason: 'Browser-side desktop runtime updater; registers nothing model-facing.' },
  ...
  'packages/host/plugin-installer': { kind: 'none', reason: 'Desktop profile package installation changes future composition and registers nothing model-facing.' },
  'packages/host/plugin-inventory': { kind: 'none', reason: 'Host-side read-only Loader projection; registers nothing model-facing.' },
  'packages/host/runtime-updater': { kind: 'none', reason: 'Desktop runtime installation changes future composition and registers nothing model-facing.' },
